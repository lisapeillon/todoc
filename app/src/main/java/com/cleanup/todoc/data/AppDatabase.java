                              ...
                              INSTANCE = Room.databaseBuilder(context, AppDatabase.class, DB_NAME)
                                    .addCallback(new Callback() {
                                          ...
                                          public void onCreate(@NonNull SupportSQLiteDatabase db) {
                                                ...
                                                executor.execute(() -> INSTANCE.projectDao().insertProject(project1));
                                                executor.execute(() -> INSTANCE.projectDao().insertProject(project2));
                                                executor.execute(() -> INSTANCE.projectDao().insertProject(project3));
                                          }
                                    })
                                    .build();
                        }
