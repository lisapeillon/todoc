...
public class TasksAdapter extends RecyclerView.Adapter<TasksAdapter.TaskViewHolder> {
       ...
       */
      public TasksAdapter(@NonNull final List<Task> tasks, @NonNull final DeleteTaskListener deleteTaskListener, MainViewModel viewModel, LifecycleOwner lifecycleOwner) {
            this.tasks = tasks;
      ...
      class TaskViewHolder extends RecyclerView.ViewHolder {
            ...
            void bind(Task task) {
                  ...
                  viewModel.getProjectById(task.getProjectId()).observe(lifecycleOwner, new Observer<Project>() {
                        @Override
